	...
	<body>
		...
		<div id="show-document" class="content scaffold-show" role="main">
			...
			<ol class="property-list document">
				...
				<g:if test="${documentInstance?.unit}">
				<li class="fieldcontain">
					<span id="unit-label" class="property-label"><g:message code="document.unit.label" default="Unit" /></span>
					
						<span class="property-value" aria-labelledby="unit-label"><g:link controller="unit" action="show" id="${documentInstance?.unit?.id}">${documentInstance?.unit?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${documentInstance?.data}">
				<li class="fieldcontain">
					<span id="data-label" class="property-label"><g:message code="document.data.label" default="Data" /></span>
